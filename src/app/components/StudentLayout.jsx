...
import { LayoutDashboard, Briefcase, FileText, CheckSquare, MessageSquare, LogOut } from "lucide-react";
...
export default function StudentLayout() {
  ...
  const menuItems = [
    ...
    { path: "/student/internships", label: "Available Internships", icon: Briefcase },
    ...
    <div className="flex h-screen bg-[#F8FAFC]">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">Intern Dashboard</p>
        </div>
